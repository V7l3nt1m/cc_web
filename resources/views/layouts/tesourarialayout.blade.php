      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="/admin/usuarios">
            ...
            <span class="nav-link-text ms-1">Minha Situação</span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link" href="/admin/logs">
            ...
            <span class="nav-link-text ms-1">Membros</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="/tesouraria/cotas">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="ni ni-support-16 text-warning text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">Cotas</span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link " href="/tesouraria/perfil">
              <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
